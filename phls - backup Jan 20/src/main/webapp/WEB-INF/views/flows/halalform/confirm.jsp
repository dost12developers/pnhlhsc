			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="text-center">
						...
						<br/><br/>						
						<h4>Address : <strong>${halalRegisterModel.address.addressLineOne}</strong></h4>
						<h4>Address : <strong>${halalRegisterModel.address.addressLineTwo}</strong></h4>
						<h4>Address : <strong>${halalRegisterModel.address.city}</strong></h4>
						<h4>City : <strong>${halalRegisterModel.address.state}</strong></h4>
						<h4>Postal Code : <strong>${halalRegisterModel.address.postalCode}</strong></h4>
						<h4>Postal Code : <strong>${halalRegisterModel.address.country}</strong></h4>
						<br/>
						<p>
