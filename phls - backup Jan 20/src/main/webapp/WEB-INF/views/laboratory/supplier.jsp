			...
			<div class="modal-body">
				<table>
					<tr>
						...
						<td><sf:input path="nameOfEstablishment" class="form-control" placeholder="Company Name" /></td>
					</tr>

	
						<tr>
						<td><sf:label path="addressOfEstablishment" class="control-label">Company Address</sf:label></td>
						<td><sf:input path="addressOfEstablishment" class="form-control" placeholder="Company Address" /></td>
					...
					<tr>
						...
						<td><sf:input path="customProduction" type="number" class="form-control" /></td>
					</tr>		
					...
					<tr>
						...
						<td><sf:input path="productVarieties" class="form-control" /></td>
					</tr>
										<tr>
						...
						<td><sf:input path="namesOfSuppliers" class="form-control" /></td>
					</tr>				
					<tr>
						<td><sf:label path="productsProcess" class="control-label">Process Flow for each Product</sf:label></td>
						<td><sf:input path="productsProcess" class="form-control" /></td>
					</tr>
