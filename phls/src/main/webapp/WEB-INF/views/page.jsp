						...
						<nav class="navbar navbar-default">
							...
							<div class="navbar-header">
								...
								<div class="logo">
									...
									</a> <a href="#/"> <img style="margin: 20px 0px" width="32px"
										height="32px" src="${images}/nav/logo.png">
									</a>
								</div>
                  ...
                  <h1><span>e</span>Business</h1> -->
                    ...
                    <ul class="dropdown-menu" role="menu">
                      ...
                      <li><a href=# >Drop Down 2</a></li>
									...
									<li><a href="http://localhost:8080/onlineshopping"><i
											class="fa fa-shopping-cart"></i>Halal Food</a></li>
								</ul>
							</div>
							<!-- navbar-collapse -->
						</nav>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="contact-icon text-center">
							<div class="single-icon">
								...
								<p>
									Call:+ 064 421 2711<br> <span>Monday-Friday
										(9am-5pm)</span>
								</p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="contact-icon text-center">
							<div class="single-icon">
								...
								<p>
									Email: zhrlaidan.r12@dost.gov.ph<br>
