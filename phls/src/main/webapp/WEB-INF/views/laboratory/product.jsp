			...
			<div class="modal-body">
				<table>
					...
					<tr>
						...
						<td><sf:input path="code" class="form-control"
								placeholder="code" /></td>
					...
					<tr>
						...
						<td><sf:input path="quantity" class="form-control"
								placeholder="Quantity" /></td>
					</tr>
					<tr>
						<td><sf:label path="unitPrice" class="control-label">Unit Price</sf:label></td>
						<td><sf:input path="unitPrice" class="form-control"
...
<%-- 					<tr>
					...
					<tr>
						...
						<td><a href="${contextRoot}/laboratory/products"
