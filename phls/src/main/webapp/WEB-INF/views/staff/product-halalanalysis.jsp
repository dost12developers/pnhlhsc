...
<div class="card mb-3">
	...
	<div class="card-body">
		...
		<div class="modal-body">
				...
				<c:forEach items="${halalAnalysisReports}" var="halalAnalysisReport">
					<tr>
						...
						<td>
							...
							<a href="${contextRoot}/staff/product/${product.id}/halalanalysis?halalanalysisId=${halalAnalysisReport.id}"><i class="fas fa-edit"></i></a>|						
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="${contextRoot}/laboratory/product/${product.id}/halalanalysis/${halalAnalysisReport.id}/delete"
			...
			<a href="${contextRoot}/staff/product/${product.id}/halalanalysis/add" class="btn btn-lg btn-primary">Add</a>
