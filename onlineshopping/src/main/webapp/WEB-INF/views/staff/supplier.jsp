...
<div class="card mb-3">
	...
	<div class="card-body">
		<sf:form class="form-horizontal" modelAttribute="supplier"
			action="${contextRoot}/staff/supplier" method="POST"
			enctype="multipart/form-data">
			<div class="modal-body">
				<table>
					<tr>
						<td><sf:label path="nameOfEstablishment"
								class="control-label">Name</sf:label></td>
						<td><sf:input path="nameOfEstablishment" class="form-control"
					...
					<tr>
						...
						<td><sf:input path="telNo" class="form-control"
					...
					<tr>
						...
						<td><sf:input path="productionAreaSize" class="form-control"
								placeholder="productionAreaSize" /></td>
					</tr>

					<tr>
						<td><sf:label path="indoorArea" class="control-label">Indoor Area</sf:label></td>
						<td><sf:input path="indoorArea" class="form-control"
								placeholder="Indoor Area (m2)" /></td>
					</tr>

					<tr>
						<td><sf:label path="openArea" class="control-label">Open Area</sf:label></td>
						<td><sf:input path="openArea" class="form-control"
								placeholder="Open Area (m2)" /></td>
					</tr>
					...
					<tr>
						...
						<td><sf:input path="productNotHalal" type="textarea"
								class="form-control"
								placeholder="State products that will not be halal certified? (If any)" /></td>
					</tr>
					<tr>
						<td><sf:label path="additionalActivities"
								class="control-label">Additional Activities</sf:label></td>
						<td><sf:input path="additionalActivities" type="textarea"
...
<%-- 					<tr>
					...
					<tr>
						<td>&nbsp;</td>
						<td><i style="color:red">Deactivate deletes the existing user account.</i></td>
					</tr>
					<tr>
						<td><sf:label path="enable" class="control-label"><b>Activate Account:</b></sf:label>
						</td>
						<td>
							<sf:radiobutton path="enable" value="true" label="Activate"/>&nbsp;&nbsp; 
							<sf:radiobutton path="enable" value="false" label="Deactivate"/>
						</td>
