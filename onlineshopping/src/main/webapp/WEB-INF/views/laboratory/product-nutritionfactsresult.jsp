			...
			<table class="table table-bordered">
				...
				<c:forEach items="${nutritionFactsResults}"
					...
					<tr>
						...
						<td>${nutritionFactsResult.value}
						<td><a
							href="${contextRoot}/laboratory/product/${product.id}/nutritionfactsresult?nutritionfactsId=${nutritionFactsResult.id}"><i
								class="fas fa-edit"></i></a>| <a href="#" data-toggle="modal"
							data-target="#mymodal${nutritionFactsResult.id}"><i
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a
												href="${contextRoot}/laboratory/product/${product.id}/nutritionfactsresult/${nutritionFactsResult.id}/delete"
